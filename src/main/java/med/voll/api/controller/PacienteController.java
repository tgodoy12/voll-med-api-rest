...
public class PacienteController {
    ...
    @Transactional
    @PutMapping
    public void actualizar(@RequestBody @Valid ActualizarPacienteDTO actualizarPacienteDTO) {
        var paciente = pacienteRepositorio.getReferenceById(actualizarPacienteDTO.id());
